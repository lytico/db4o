...
public class RemoteRoleActors  implements java.io.Serializable {
    ...
    private com.atlassian.jira.rpc.soap.client.RemoteRoleActor[] roleActors;
     ...
     * @return roleActors
     */
    public com.atlassian.jira.rpc.soap.client.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(com.atlassian.jira.rpc.soap.client.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
