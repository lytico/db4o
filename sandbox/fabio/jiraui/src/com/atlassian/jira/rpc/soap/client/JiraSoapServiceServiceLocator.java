...
public class JiraSoapServiceServiceLocator extends org.apache.axis.client.Service implements com.atlassian.jira.rpc.soap.client.JiraSoapServiceService {
    ...
    private java.lang.String JirasoapserviceV2_address = "http://localhost:8090/jira/rpc/soap/jirasoapservice-v2";
    ...
    public com.atlassian.jira.rpc.soap.client.JiraSoapService getJirasoapserviceV2(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.atlassian.jira.rpc.soap.client.JirasoapserviceV2SoapBindingStub _stub = new com.atlassian.jira.rpc.soap.client.JirasoapserviceV2SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.atlassian.jira.rpc.soap.client.JiraSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.atlassian.jira.rpc.soap.client.JirasoapserviceV2SoapBindingStub _stub = new com.atlassian.jira.rpc.soap.client.JirasoapserviceV2SoapBindingStub(new java.net.URL(JirasoapserviceV2_address), this);
                _stub.setPortName(getJirasoapserviceV2WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8090/jira/rpc/soap/jirasoapservice-v2", "JiraSoapServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8090/jira/rpc/soap/jirasoapservice-v2", "jirasoapservice-v2"));
        }
