...
public class RemotePermissionMapping  implements java.io.Serializable {
    private com.atlassian.jira.rpc.soap.client.RemotePermission permission;

    private com.atlassian.jira.rpc.soap.client.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           com.atlassian.jira.rpc.soap.client.RemotePermission permission,
           com.atlassian.jira.rpc.soap.client.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public com.atlassian.jira.rpc.soap.client.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(com.atlassian.jira.rpc.soap.client.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public com.atlassian.jira.rpc.soap.client.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(com.atlassian.jira.rpc.soap.client.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
