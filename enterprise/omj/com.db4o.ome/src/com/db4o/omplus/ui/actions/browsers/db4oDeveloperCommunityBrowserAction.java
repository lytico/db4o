...
public class db4oDeveloperCommunityBrowserAction implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action) 
	{
		...
		try 
		{
			...
			{
				if(ref[i].getTitle().equals(OMPlusConstants.DB4O_DEVELOPER_COMMUNITY_BROWSER_NAME))
				{
			...
			IWebBrowser browser = support.createBrowser(browserStyle,
		    									OMPlusConstants.DB4O_DEVELOPER_COMMUNITY_BROWSER_ID,
		    									OMPlusConstants.DB4O_DEVELOPER_COMMUNITY_BROWSER_NAME,
		    									OMPlusConstants.DB4O_DEVELOPER_COMMUNITY_TOOLTIP);
			
			browser.openURL(new URL(OMPlusConstants.DB4O_DEVELOPER_COMMUNITY_URL));
